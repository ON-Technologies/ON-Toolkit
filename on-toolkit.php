...
register_activation_hook(__FILE__, ['ONToolkit\\Core\\Database\\Schema', 'activate']);
register_deactivation_hook(__FILE__, ['ONToolkit\\Core\\Database\\Schema', 'deactivate']);
