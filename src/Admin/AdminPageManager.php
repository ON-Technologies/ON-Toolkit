...
class AdminPageManager
{
    ...
    public function enqueueAssets(string $hook_suffix): void
    {
        ...
        wp_enqueue_style('ontk-admin-app-css', ONTK_PLUGIN_URL . 'assets/css/admin-app.css', [], ONTK_VERSION);
        wp_enqueue_script('ontk-admin-app-js', ONTK_PLUGIN_URL . 'assets/js/admin-app.js', [], ONTK_VERSION, true);

        wp_localize_script('ontk-admin-app-js', 'ontkAppConfig', [
